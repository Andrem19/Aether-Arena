                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                AvatarInTheBattle.getAvatar(
                                    controller.enemy_accData, width),
                                Column(
                                  children: [
                                    Row(
                                      crossAxisAlignment:
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    BattleName.getName(
                                        controller.my_accData.name),
                                    AvatarInTheBattle.getAvatar(
                                        controller.my_accData, width),
                                  ],
                                ),
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.end,
